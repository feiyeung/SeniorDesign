...
****************************************************************************//**
*
*  Prepares the UART_2 component to enter Deep Sleep.
...
*    disabling.
*
*  Call the UART_2_Sleep() function before calling the 
...
****************************************************************************//**
*
*  Prepares the UART_2 component for Active mode operation after 
*  Deep Sleep.
...
*
*  \sideeffect
*   Calling the UART_2_Wakeup() function without first calling the 
*   UART_2_Sleep() function may produce unexpected behavior.
*
*******************************************************************************/
