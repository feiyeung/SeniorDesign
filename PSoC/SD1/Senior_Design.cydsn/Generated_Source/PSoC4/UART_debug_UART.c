...
void UART_debug_UartPostEnable(void)
{
        ...
        if (UART_debug_CHECK_TX_SDA_MISO_PIN_USED)
        {
            /* Set SCB UART to drive the output pin */
            UART_debug_SET_HSIOM_SEL(UART_debug_TX_SDA_MISO_HSIOM_REG, UART_debug_TX_SDA_MISO_HSIOM_MASK,
                                           UART_debug_TX_SDA_MISO_HSIOM_POS, UART_debug_TX_SDA_MISO_HSIOM_SEL_UART);
        }
    #endif /* (UART_debug_TX_SDA_MISO_PIN_PIN) */

    #if !(UART_debug_CY_SCBIP_V0 || UART_debug_CY_SCBIP_V1)
        #if (UART_debug_SS0_PIN)
            if (UART_debug_CHECK_SS0_PIN_USED)
            {
                /* Set SCB UART to drive the output pin */
                UART_debug_SET_HSIOM_SEL(UART_debug_SS0_HSIOM_REG, UART_debug_SS0_HSIOM_MASK,
                                               UART_debug_SS0_HSIOM_POS, UART_debug_SS0_HSIOM_SEL_UART);
            }
...
void UART_debug_UartStop(void)
{
        ...
        if (UART_debug_CHECK_TX_SDA_MISO_PIN_USED)
        {
            ...
            UART_debug_SET_HSIOM_SEL(UART_debug_TX_SDA_MISO_HSIOM_REG, UART_debug_TX_SDA_MISO_HSIOM_MASK,
                                           UART_debug_TX_SDA_MISO_HSIOM_POS, UART_debug_TX_SDA_MISO_HSIOM_SEL_GPIO);
        }
    #endif /* (UART_debug_TX_SDA_MISO_PIN_PIN) */
            ...
            if (UART_debug_CHECK_SS0_PIN_USED)
            {
                ...
                UART_debug_spi_ss0_Write(UART_debug_GET_UART_RTS_INACTIVE);

                /* Set GPIO to drive output pin */
                UART_debug_SET_HSIOM_SEL(UART_debug_SS0_HSIOM_REG, UART_debug_SS0_HSIOM_MASK,
                                               UART_debug_SS0_HSIOM_POS, UART_debug_SS0_HSIOM_SEL_GPIO);
            }
        #endif /* (UART_debug_SS0_PIN) */
    #endif /* !(UART_debug_CY_SCBIP_V0 || UART_debug_CY_SCBIP_V1) */
