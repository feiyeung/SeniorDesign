...
uint8 UART_2_initVar = 0u;
    ...
    * UART_2_Stop() is called. Only these TX interrupt sources 
    * will be restored on a subsequent UART_2_Enable() call.
    */
    uint16 UART_2_IntrTxMask = 0u;
...
****************************************************************************//**
*
*  Initializes the UART_2 component to operate in one of the selected
*  configurations: I2C, SPI, UART or EZI2C.
*  When the configuration is set to "Unconfigured SCB", this function does
*  not do any initialization. Use mode-specific initialization APIs instead:
*  UART_2_I2CInit, UART_2_SpiInit, 
*  UART_2_UartInit or UART_2_EzI2CInit.
*
*******************************************************************************/
...
****************************************************************************//**
*
*  Enables UART_2 component operation: activates the hardware and 
*  internal interrupt. It also restores TX interrupt sources disabled after the 
*  UART_2_Stop() function was called (note that level-triggered TX 
*  interrupt sources remain disabled to not cause code lock-up).
*  For I2C and EZI2C modes the interrupt is internal and mandatory for 
*  operation. For SPI and UART modes the interrupt can be configured as none, 
*  internal or external.
*  The UART_2 configuration should be not changed when the component
*  is enabled. Any configuration changes should be made after disabling the 
*  component.
*  When configuration is set to “Unconfigured UART_2”, the component 
...
****************************************************************************//**
*
*  Disables the UART_2 component: disable the hardware and internal 
*  interrupt. It also disables all TX interrupt sources so as not to cause an 
*  unexpected interrupt trigger because after the component is enabled, the 
*  TX FIFO is empty.
*  Refer to the function UART_2_Enable() for the interrupt 
...
static void UART_2_ScbModeStop(void)
{
    ...
    *******************************************************************************/
    void UART_2_SetPins(uint32 mode, uint32 subMode, uint32 uartEnableMask)
    {
        ...
        {
            UART_2_RX_SCL_MOSI_HSIOM_SEL_GPIO,
            UART_2_TX_SDA_MISO_HSIOM_SEL_GPIO,
            0u,
            0u,
            0u,
            0u,
            ...
            (UART_2_SCB_MODE_EZI2C == mode))
        {
            ...
            hsiomSel[UART_2_RX_SCL_MOSI_PIN_INDEX] = UART_2_RX_SCL_MOSI_HSIOM_SEL_I2C;
            pinsDm  [UART_2_RX_SCL_MOSI_PIN_INDEX] = UART_2_PIN_DM_OD_LO;
        #elif (UART_2_RX_WAKE_SCL_MOSI_PIN)
            hsiomSel[UART_2_RX_WAKE_SCL_MOSI_PIN_INDEX] = UART_2_RX_WAKE_SCL_MOSI_HSIOM_SEL_I2C;
            pinsDm  [UART_2_RX_WAKE_SCL_MOSI_PIN_INDEX] = UART_2_PIN_DM_OD_LO;
        #else
        #endif /* (UART_2_RX_SCL_MOSI_PIN) */
        
        #if (UART_2_TX_SDA_MISO_PIN)
            hsiomSel[UART_2_TX_SDA_MISO_PIN_INDEX] = UART_2_TX_SDA_MISO_HSIOM_SEL_I2C;
        ...
        {
        #if (UART_2_RX_SCL_MOSI_PIN)
            hsiomSel[UART_2_RX_SCL_MOSI_PIN_INDEX] = UART_2_RX_SCL_MOSI_HSIOM_SEL_SPI;
        #elif (UART_2_RX_WAKE_SCL_MOSI_PIN)
            hsiomSel[UART_2_RX_WAKE_SCL_MOSI_PIN_INDEX] = UART_2_RX_WAKE_SCL_MOSI_HSIOM_SEL_SPI;
        #else
        #endif /* (UART_2_RX_SCL_MOSI_PIN) */
        
        #if (UART_2_TX_SDA_MISO_PIN)
            hsiomSel[UART_2_TX_SDA_MISO_PIN_INDEX] = UART_2_TX_SDA_MISO_HSIOM_SEL_SPI;
        #endif /* (UART_2_TX_SDA_MISO_PIN) */
        
        #if (UART_2_SCLK_PIN)
            hsiomSel[UART_2_SCLK_PIN_INDEX] = UART_2_SCLK_HSIOM_SEL_SPI;
            ...
            if (UART_2_SPI_SLAVE == subMode)
            {
                ...
                hsiomSel[UART_2_SS0_PIN_INDEX] = UART_2_SS0_HSIOM_SEL_SPI;
        ...
        else /* UART */
        {
            if (UART_2_UART_MODE_SMARTCARD == subMode)
            {
                /* SmartCard */
            #if (UART_2_TX_SDA_MISO_PIN)
                hsiomSel[UART_2_TX_SDA_MISO_PIN_INDEX] = UART_2_TX_SDA_MISO_HSIOM_SEL_UART;
                pinsDm  [UART_2_TX_SDA_MISO_PIN_INDEX] = UART_2_PIN_DM_OD_LO;
            #endif /* (UART_2_TX_SDA_MISO_PIN) */
            }
            else /* Standard or IrDA */
            {
                ...
                {
                #if (UART_2_RX_SCL_MOSI_PIN)
                    hsiomSel[UART_2_RX_SCL_MOSI_PIN_INDEX] = UART_2_RX_SCL_MOSI_HSIOM_SEL_UART;
                    pinsDm  [UART_2_RX_SCL_MOSI_PIN_INDEX] = UART_2_PIN_DM_DIG_HIZ;
                #elif (UART_2_RX_WAKE_SCL_MOSI_PIN)
                    hsiomSel[UART_2_RX_WAKE_SCL_MOSI_PIN_INDEX] = UART_2_RX_WAKE_SCL_MOSI_HSIOM_SEL_UART;
                    pinsDm  [UART_2_RX_WAKE_SCL_MOSI_PIN_INDEX] = UART_2_PIN_DM_DIG_HIZ;
                #else
                #endif /* (UART_2_RX_SCL_MOSI_PIN) */
                }
                ...
                if (UART_2_UART_MODE_STD == subMode)
                {
                    ...
                    #if (UART_2_SCLK_PIN)
                        hsiomSel[UART_2_SCLK_PIN_INDEX] = UART_2_SCLK_HSIOM_SEL_UART;
                        pinsDm  [UART_2_SCLK_PIN_INDEX] = UART_2_PIN_DM_DIG_HIZ;
                    #endif /* (UART_2_SCLK_PIN) */
                    }
                    ...
                    #if (UART_2_SS0_PIN)
                        hsiomSel[UART_2_SS0_PIN_INDEX] = UART_2_SS0_HSIOM_SEL_UART;
                        pinsDm  [UART_2_SS0_PIN_INDEX] = UART_2_PIN_DM_STRONG;
