...
#define UART_debug_REMOVE_SCLK_PIN      (1u)
#define UART_debug_REMOVE_SS0_PIN      (1u)
...
#define UART_debug_SCLK_PIN     (0u == UART_debug_REMOVE_SCLK_PIN)
#define UART_debug_SS0_PIN     (0u == UART_debug_REMOVE_SS0_PIN)
...
****************************************/
    ...
    #include "UART_debug_spi_sclk.h"
#endif /* (UART_debug_SCLK) */

#if (UART_debug_SS0_PIN)
    #include "UART_debug_spi_ss0.h"
...
***************************************/
    ...
    #define UART_debug_RX_SCL_MOSI_HSIOM_SEL_GPIO  (UART_debug_uart_rx_i2c_scl_spi_mosi__0__HSIOM_GPIO)
    #define UART_debug_RX_SCL_MOSI_HSIOM_SEL_I2C   (UART_debug_uart_rx_i2c_scl_spi_mosi__0__HSIOM_I2C)
    #define UART_debug_RX_SCL_MOSI_HSIOM_SEL_SPI   (UART_debug_uart_rx_i2c_scl_spi_mosi__0__HSIOM_SPI)
    #define UART_debug_RX_SCL_MOSI_HSIOM_SEL_UART  (UART_debug_uart_rx_i2c_scl_spi_mosi__0__HSIOM_UART)
    
#elif (UART_debug_RX_WAKE_SCL_MOSI_PIN)
    #define UART_debug_RX_WAKE_SCL_MOSI_HSIOM_REG   (*(reg32 *) UART_debug_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM)
    #define UART_debug_RX_WAKE_SCL_MOSI_HSIOM_PTR   ( (reg32 *) UART_debug_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM)
    
    #define UART_debug_RX_WAKE_SCL_MOSI_HSIOM_MASK      (UART_debug_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM_MASK)
    #define UART_debug_RX_WAKE_SCL_MOSI_HSIOM_POS       (UART_debug_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM_SHIFT)
    #define UART_debug_RX_WAKE_SCL_MOSI_HSIOM_SEL_GPIO  (UART_debug_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM_GPIO)
    #define UART_debug_RX_WAKE_SCL_MOSI_HSIOM_SEL_I2C   (UART_debug_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM_I2C)
    #define UART_debug_RX_WAKE_SCL_MOSI_HSIOM_SEL_SPI   (UART_debug_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM_SPI)
    #define UART_debug_RX_WAKE_SCL_MOSI_HSIOM_SEL_UART  (UART_debug_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM_UART)    
   
    #define UART_debug_RX_WAKE_SCL_MOSI_INTCFG_REG (*(reg32 *) UART_debug_uart_rx_wake_i2c_scl_spi_mosi__0__INTCFG)
    #define UART_debug_RX_WAKE_SCL_MOSI_INTCFG_PTR ( (reg32 *) UART_debug_uart_rx_wake_i2c_scl_spi_mosi__0__INTCFG)
    #define UART_debug_RX_WAKE_SCL_MOSI_INTCFG_TYPE_POS  (UART_debug_uart_rx_wake_i2c_scl_spi_mosi__SHIFT)
    #define UART_debug_RX_WAKE_SCL_MOSI_INTCFG_TYPE_MASK ((uint32) UART_debug_INTCFG_TYPE_MASK << \
                                                                           UART_debug_RX_WAKE_SCL_MOSI_INTCFG_TYPE_POS)
#else
    /* None of pins UART_debug_RX_SCL_MOSI_PIN or UART_debug_RX_WAKE_SCL_MOSI_PIN present.*/
    ...
    #define UART_debug_TX_SDA_MISO_HSIOM_SEL_GPIO  (UART_debug_uart_tx_i2c_sda_spi_miso__0__HSIOM_GPIO)
    #define UART_debug_TX_SDA_MISO_HSIOM_SEL_I2C   (UART_debug_uart_tx_i2c_sda_spi_miso__0__HSIOM_I2C)
    #define UART_debug_TX_SDA_MISO_HSIOM_SEL_SPI   (UART_debug_uart_tx_i2c_sda_spi_miso__0__HSIOM_SPI)
    #define UART_debug_TX_SDA_MISO_HSIOM_SEL_UART  (UART_debug_uart_tx_i2c_sda_spi_miso__0__HSIOM_UART)
#endif /* (UART_debug_TX_SDA_MISO_PIN) */

#if (UART_debug_SCLK_PIN)
    #define UART_debug_SCLK_HSIOM_REG   (*(reg32 *) UART_debug_spi_sclk__0__HSIOM)
    #define UART_debug_SCLK_HSIOM_PTR   ( (reg32 *) UART_debug_spi_sclk__0__HSIOM)
    
    #define UART_debug_SCLK_HSIOM_MASK      (UART_debug_spi_sclk__0__HSIOM_MASK)
    #define UART_debug_SCLK_HSIOM_POS       (UART_debug_spi_sclk__0__HSIOM_SHIFT)
    #define UART_debug_SCLK_HSIOM_SEL_GPIO  (UART_debug_spi_sclk__0__HSIOM_GPIO)
    #define UART_debug_SCLK_HSIOM_SEL_I2C   (UART_debug_spi_sclk__0__HSIOM_I2C)
    #define UART_debug_SCLK_HSIOM_SEL_SPI   (UART_debug_spi_sclk__0__HSIOM_SPI)
    #define UART_debug_SCLK_HSIOM_SEL_UART  (UART_debug_spi_sclk__0__HSIOM_UART)
#endif /* (UART_debug_SCLK_PIN) */

#if (UART_debug_SS0_PIN)
    #define UART_debug_SS0_HSIOM_REG   (*(reg32 *) UART_debug_spi_ss0__0__HSIOM)
    #define UART_debug_SS0_HSIOM_PTR   ( (reg32 *) UART_debug_spi_ss0__0__HSIOM)
    
    #define UART_debug_SS0_HSIOM_MASK      (UART_debug_spi_ss0__0__HSIOM_MASK)
    #define UART_debug_SS0_HSIOM_POS       (UART_debug_spi_ss0__0__HSIOM_SHIFT)
    #define UART_debug_SS0_HSIOM_SEL_GPIO  (UART_debug_spi_ss0__0__HSIOM_GPIO)
    #define UART_debug_SS0_HSIOM_SEL_I2C   (UART_debug_spi_ss0__0__HSIOM_I2C)
    #define UART_debug_SS0_HSIOM_SEL_SPI   (UART_debug_spi_ss0__0__HSIOM_SPI)
#if !(UART_debug_CY_SCBIP_V0 || UART_debug_CY_SCBIP_V1)
    #define UART_debug_SS0_HSIOM_SEL_UART  (UART_debug_spi_ss0__0__HSIOM_UART)
    ...
    #define UART_debug_SS1_HSIOM_SEL_GPIO (UART_debug_spi_ss1__0__HSIOM_GPIO)
    #define UART_debug_SS1_HSIOM_SEL_I2C  (UART_debug_spi_ss1__0__HSIOM_I2C)
    #define UART_debug_SS1_HSIOM_SEL_SPI  (UART_debug_spi_ss1__0__HSIOM_SPI)
#endif /* (UART_debug_SS1_PIN) */
    ...
    #define UART_debug_SS2_HSIOM_SEL_GPIO (UART_debug_spi_ss2__0__HSIOM_GPIO)
    #define UART_debug_SS2_HSIOM_SEL_I2C  (UART_debug_spi_ss2__0__HSIOM_I2C)
    #define UART_debug_SS2_HSIOM_SEL_SPI  (UART_debug_spi_ss2__0__HSIOM_SPI)
#endif /* (UART_debug_SS2_PIN) */
    ...
    #define UART_debug_SS3_HSIOM_SEL_GPIO (UART_debug_spi_ss3__0__HSIOM_GPIO)
    #define UART_debug_SS3_HSIOM_SEL_I2C  (UART_debug_spi_ss3__0__HSIOM_I2C)
    #define UART_debug_SS3_HSIOM_SEL_SPI  (UART_debug_spi_ss3__0__HSIOM_SPI)
#endif /* (UART_debug_SS3_PIN) */
    ...
    #define UART_debug_SCL_HSIOM_SEL_GPIO (UART_debug_sda__0__HSIOM_GPIO)
    #define UART_debug_SCL_HSIOM_SEL_I2C  (UART_debug_sda__0__HSIOM_I2C)
    ...
    #define UART_debug_SDA_HSIOM_SEL_GPIO (UART_debug_sda__0__HSIOM_GPIO)
    #define UART_debug_SDA_HSIOM_SEL_I2C  (UART_debug_sda__0__HSIOM_I2C)
#endif /* (UART_debug_I2C_PINS) */

#if (UART_debug_SPI_SLAVE_PINS)
    #define UART_debug_SCLK_S_HSIOM_REG   (*(reg32 *) UART_debug_sclk_s__0__HSIOM)
    #define UART_debug_SCLK_S_HSIOM_PTR   ( (reg32 *) UART_debug_sclk_s__0__HSIOM)
    
    #define UART_debug_SCLK_S_HSIOM_MASK      (UART_debug_sclk_s__0__HSIOM_MASK)
    #define UART_debug_SCLK_S_HSIOM_POS       (UART_debug_sclk_s__0__HSIOM_SHIFT)
    #define UART_debug_SCLK_S_HSIOM_SEL_GPIO  (UART_debug_sclk_s__0__HSIOM_GPIO)
    #define UART_debug_SCLK_S_HSIOM_SEL_SPI   (UART_debug_sclk_s__0__HSIOM_SPI)
    
    #define UART_debug_SS0_S_HSIOM_REG    (*(reg32 *) UART_debug_ss0_s__0__HSIOM)
    #define UART_debug_SS0_S_HSIOM_PTR    ( (reg32 *) UART_debug_ss0_s__0__HSIOM)
    
    #define UART_debug_SS0_S_HSIOM_MASK       (UART_debug_ss0_s__0__HSIOM_MASK)
    #define UART_debug_SS0_S_HSIOM_POS        (UART_debug_ss0_s__0__HSIOM_SHIFT)
    #define UART_debug_SS0_S_HSIOM_SEL_GPIO   (UART_debug_ss0_s__0__HSIOM_GPIO)  
    #define UART_debug_SS0_S_HSIOM_SEL_SPI    (UART_debug_ss0_s__0__HSIOM_SPI)
#endif /* (UART_debug_SPI_SLAVE_PINS) */

#if (UART_debug_SPI_SLAVE_MOSI_PIN)
    #define UART_debug_MOSI_S_HSIOM_REG   (*(reg32 *) UART_debug_mosi_s__0__HSIOM)
    #define UART_debug_MOSI_S_HSIOM_PTR   ( (reg32 *) UART_debug_mosi_s__0__HSIOM)
    
    #define UART_debug_MOSI_S_HSIOM_MASK      (UART_debug_mosi_s__0__HSIOM_MASK)
    #define UART_debug_MOSI_S_HSIOM_POS       (UART_debug_mosi_s__0__HSIOM_SHIFT)
    #define UART_debug_MOSI_S_HSIOM_SEL_GPIO  (UART_debug_mosi_s__0__HSIOM_GPIO)
    #define UART_debug_MOSI_S_HSIOM_SEL_SPI   (UART_debug_mosi_s__0__HSIOM_SPI)
#endif /* (UART_debug_SPI_SLAVE_MOSI_PIN) */

#if (UART_debug_SPI_SLAVE_MISO_PIN)
    #define UART_debug_MISO_S_HSIOM_REG   (*(reg32 *) UART_debug_miso_s__0__HSIOM)
    #define UART_debug_MISO_S_HSIOM_PTR   ( (reg32 *) UART_debug_miso_s__0__HSIOM)
    
    #define UART_debug_MISO_S_HSIOM_MASK      (UART_debug_miso_s__0__HSIOM_MASK)
    #define UART_debug_MISO_S_HSIOM_POS       (UART_debug_miso_s__0__HSIOM_SHIFT)
    #define UART_debug_MISO_S_HSIOM_SEL_GPIO  (UART_debug_miso_s__0__HSIOM_GPIO)
    #define UART_debug_MISO_S_HSIOM_SEL_SPI   (UART_debug_miso_s__0__HSIOM_SPI)
#endif /* (UART_debug_SPI_SLAVE_MISO_PIN) */

#if (UART_debug_SPI_MASTER_MISO_PIN)
    #define UART_debug_MISO_M_HSIOM_REG   (*(reg32 *) UART_debug_miso_m__0__HSIOM)
    #define UART_debug_MISO_M_HSIOM_PTR   ( (reg32 *) UART_debug_miso_m__0__HSIOM)
    
    #define UART_debug_MISO_M_HSIOM_MASK      (UART_debug_miso_m__0__HSIOM_MASK)
    #define UART_debug_MISO_M_HSIOM_POS       (UART_debug_miso_m__0__HSIOM_SHIFT)
    #define UART_debug_MISO_M_HSIOM_SEL_GPIO  (UART_debug_miso_m__0__HSIOM_GPIO)
    #define UART_debug_MISO_M_HSIOM_SEL_SPI   (UART_debug_miso_m__0__HSIOM_SPI)
#endif /* (UART_debug_SPI_MASTER_MISO_PIN) */

#if (UART_debug_SPI_MASTER_MOSI_PIN)
    #define UART_debug_MOSI_M_HSIOM_REG   (*(reg32 *) UART_debug_mosi_m__0__HSIOM)
    #define UART_debug_MOSI_M_HSIOM_PTR   ( (reg32 *) UART_debug_mosi_m__0__HSIOM)
    
    #define UART_debug_MOSI_M_HSIOM_MASK      (UART_debug_mosi_m__0__HSIOM_MASK)
    #define UART_debug_MOSI_M_HSIOM_POS       (UART_debug_mosi_m__0__HSIOM_SHIFT)
    #define UART_debug_MOSI_M_HSIOM_SEL_GPIO  (UART_debug_mosi_m__0__HSIOM_GPIO)
    #define UART_debug_MOSI_M_HSIOM_SEL_SPI   (UART_debug_mosi_m__0__HSIOM_SPI)
#endif /* (UART_debug_SPI_MASTER_MOSI_PIN) */
    ...
    #define UART_debug_SCLK_M_HSIOM_SEL_GPIO  (UART_debug_sclk_m__0__HSIOM_GPIO)
    #define UART_debug_SCLK_M_HSIOM_SEL_SPI   (UART_debug_sclk_m__0__HSIOM_SPI)
#endif /* (UART_debug_SPI_MASTER_SCLK_PIN) */
    ...
    #define UART_debug_SS0_M_HSIOM_SEL_GPIO   (UART_debug_ss0_m__0__HSIOM_GPIO)
    #define UART_debug_SS0_M_HSIOM_SEL_SPI    (UART_debug_ss0_m__0__HSIOM_SPI)
#endif /* (UART_debug_SPI_MASTER_SS0_PIN) */
    ...
    #define UART_debug_SS1_M_HSIOM_SEL_GPIO   (UART_debug_ss1_m__0__HSIOM_GPIO)
    #define UART_debug_SS1_M_HSIOM_SEL_SPI    (UART_debug_ss1_m__0__HSIOM_SPI)
#endif /* (UART_debug_SPI_MASTER_SS1_PIN) */
    ...
    #define UART_debug_SS2_M_HSIOM_SEL_GPIO   (UART_debug_ss2_m__0__HSIOM_GPIO)
    #define UART_debug_SS2_M_HSIOM_SEL_SPI    (UART_debug_ss2_m__0__HSIOM_SPI)
#endif /* (UART_debug_SPI_MASTER_SS2_PIN) */
    ...
    #define UART_debug_SS3_M_HSIOM_SEL_GPIO  (UART_debug_ss3_m__0__HSIOM_GPIO)
    #define UART_debug_SS3_M_HSIOM_SEL_SPI   (UART_debug_ss3_m__0__HSIOM_SPI)
#endif /* (UART_debug_SPI_MASTER_SS3_PIN) */

#if (UART_debug_UART_RX_PIN)
    #define UART_debug_RX_HSIOM_REG   (*(reg32 *) UART_debug_rx__0__HSIOM)
    #define UART_debug_RX_HSIOM_PTR   ( (reg32 *) UART_debug_rx__0__HSIOM)
    
    #define UART_debug_RX_HSIOM_MASK      (UART_debug_rx__0__HSIOM_MASK)
    #define UART_debug_RX_HSIOM_POS       (UART_debug_rx__0__HSIOM_SHIFT)
    #define UART_debug_RX_HSIOM_SEL_GPIO  (UART_debug_rx__0__HSIOM_GPIO)
    #define UART_debug_RX_HSIOM_SEL_UART  (UART_debug_rx__0__HSIOM_UART)
#endif /* (UART_debug_UART_RX_PIN) */

#if (UART_debug_UART_RX_WAKE_PIN)
    #define UART_debug_RX_WAKE_HSIOM_REG   (*(reg32 *) UART_debug_rx_wake__0__HSIOM)
    #define UART_debug_RX_WAKE_HSIOM_PTR   ( (reg32 *) UART_debug_rx_wake__0__HSIOM)
    
    #define UART_debug_RX_WAKE_HSIOM_MASK      (UART_debug_rx_wake__0__HSIOM_MASK)
    #define UART_debug_RX_WAKE_HSIOM_POS       (UART_debug_rx_wake__0__HSIOM_SHIFT)
    #define UART_debug_RX_WAKE_HSIOM_SEL_GPIO  (UART_debug_rx_wake__0__HSIOM_GPIO)
    #define UART_debug_RX_WAKE_HSIOM_SEL_UART  (UART_debug_rx_wake__0__HSIOM_UART)
#endif /* (UART_debug_UART_WAKE_RX_PIN) */

#if (UART_debug_UART_CTS_PIN)
    #define UART_debug_CTS_HSIOM_REG   (*(reg32 *) UART_debug_cts__0__HSIOM)
    #define UART_debug_CTS_HSIOM_PTR   ( (reg32 *) UART_debug_cts__0__HSIOM)
    
    #define UART_debug_CTS_HSIOM_MASK      (UART_debug_cts__0__HSIOM_MASK)
    #define UART_debug_CTS_HSIOM_POS       (UART_debug_cts__0__HSIOM_SHIFT)
    #define UART_debug_CTS_HSIOM_SEL_GPIO  (UART_debug_cts__0__HSIOM_GPIO)
    #define UART_debug_CTS_HSIOM_SEL_UART  (UART_debug_cts__0__HSIOM_UART)
#endif /* (UART_debug_UART_CTS_PIN) */

#if (UART_debug_UART_TX_PIN)
    #define UART_debug_TX_HSIOM_REG   (*(reg32 *) UART_debug_tx__0__HSIOM)
    #define UART_debug_TX_HSIOM_PTR   ( (reg32 *) UART_debug_tx__0__HSIOM)
    
    #define UART_debug_TX_HSIOM_MASK      (UART_debug_tx__0__HSIOM_MASK)
    #define UART_debug_TX_HSIOM_POS       (UART_debug_tx__0__HSIOM_SHIFT)
    #define UART_debug_TX_HSIOM_SEL_GPIO  (UART_debug_tx__0__HSIOM_GPIO)
    #define UART_debug_TX_HSIOM_SEL_UART  (UART_debug_tx__0__HSIOM_UART)
#endif /* (UART_debug_UART_TX_PIN) */

#if (UART_debug_UART_RX_TX_PIN)
    #define UART_debug_RX_TX_HSIOM_REG   (*(reg32 *) UART_debug_rx_tx__0__HSIOM)
    #define UART_debug_RX_TX_HSIOM_PTR   ( (reg32 *) UART_debug_rx_tx__0__HSIOM)
    
    #define UART_debug_RX_TX_HSIOM_MASK      (UART_debug_rx_tx__0__HSIOM_MASK)
    #define UART_debug_RX_TX_HSIOM_POS       (UART_debug_rx_tx__0__HSIOM_SHIFT)
    #define UART_debug_RX_TX_HSIOM_SEL_GPIO  (UART_debug_rx_tx__0__HSIOM_GPIO)
    #define UART_debug_RX_TX_HSIOM_SEL_UART  (UART_debug_rx_tx__0__HSIOM_UART)
#endif /* (UART_debug_UART_RX_TX_PIN) */
    ...
    #define UART_debug_RTS_HSIOM_SEL_GPIO (UART_debug_rts__0__HSIOM_GPIO)
    #define UART_debug_RTS_HSIOM_SEL_UART (UART_debug_rts__0__HSIOM_UART)    
#endif /* (UART_debug_UART_RTS_PIN) */
...
/* The HSIOM values provided below are valid only for UART_debug_CY_SCBIP_V0 
* and UART_debug_CY_SCBIP_V1. It is not recommended to use them for 
* UART_debug_CY_SCBIP_V2. Use pin name specific HSIOM constants provided 
...
#define UART_debug_SCLK_PIN_INDEX       (2u)
#define UART_debug_SS0_PIN_INDEX       (3u)
...
#define UART_debug_SCLK_PIN_MASK     ((uint32) 0x01u << UART_debug_SCLK_PIN_INDEX)
#define UART_debug_SS0_PIN_MASK     ((uint32) 0x01u << UART_debug_SS0_PIN_INDEX)
...
#if (UART_debug_SS0_PIN)
    #define UART_debug_CHECK_SS0_PIN_USED \
                (UART_debug_PIN_DM_ALG_HIZ != \
                    UART_debug_GET_P4_PIN_DM(UART_debug_spi_ss0_PC, \
                                                   UART_debug_spi_ss0_SHIFT))
#endif /* (UART_debug_SS0_PIN) */
...
#else
    #define UART_debug_SET_I2C_SCL_DR(val)        do{ /* Does nothing */ }while(0)
    #define UART_debug_SET_I2C_SCL_HSIOM_SEL(sel) do{ /* Does nothing */ }while(0)
...
#if (UART_debug_RX_SCL_MOSI_PIN)
    #define UART_debug_CLEAR_UART_RX_WAKE_INTR        do{ /* Does nothing */ }while(0)
    
#elif (UART_debug_RX_WAKE_SCL_MOSI_PIN)
    #define UART_debug_CLEAR_UART_RX_WAKE_INTR \
            do{                                      \
                (void) UART_debug_uart_rx_wake_i2c_scl_spi_mosi_ClearInterrupt(); \
            }while(0)

#elif(UART_debug_UART_RX_WAKE_PIN)
    #define UART_debug_CLEAR_UART_RX_WAKE_INTR \
            do{                                      \
                (void) UART_debug_rx_wake_ClearInterrupt(); \
            }while(0)
#else
#endif /* (UART_debug_RX_SCL_MOSI_PIN) */
...
#define UART_debug_REMOVE_SCLK_PIN                UART_debug_REMOVE_SCLK_PIN
#endif /* UART_debug_REMOVE_SCLK_PIN */
#ifndef UART_debug_REMOVE_SS0_PIN
#define UART_debug_REMOVE_SS0_PIN                 UART_debug_REMOVE_SS0_PIN
...
#define UART_debug_SCLK_PIN               UART_debug_SCLK_PIN
#endif /* UART_debug_SCLK_PIN */
#ifndef UART_debug_SS0_PIN
#define UART_debug_SS0_PIN                UART_debug_SS0_PIN
#endif /* UART_debug_SS0_PIN */
    ...
    #define UART_debug_SCLK_HSIOM_REG     UART_debug_SCLK_HSIOM_REG
    #define UART_debug_SCLK_HSIOM_PTR     UART_debug_SCLK_HSIOM_PTR
    #define UART_debug_SCLK_HSIOM_MASK    UART_debug_SCLK_HSIOM_MASK
    #define UART_debug_SCLK_HSIOM_POS     UART_debug_SCLK_HSIOM_POS
    #endif /* UART_debug_SCLK_HSIOM_REG */
#endif /* (UART_debug_SCLK_PIN) */

#if (UART_debug_SS0_PIN)
    #ifndef UART_debug_SS0_HSIOM_REG
    #define UART_debug_SS0_HSIOM_REG      UART_debug_SS0_HSIOM_REG
    #define UART_debug_SS0_HSIOM_PTR      UART_debug_SS0_HSIOM_PTR
    #define UART_debug_SS0_HSIOM_MASK     UART_debug_SS0_HSIOM_MASK
    #define UART_debug_SS0_HSIOM_POS      UART_debug_SS0_HSIOM_POS
...
#define UART_debug_SCLK_PIN_INDEX             UART_debug_SCLK_PIN_INDEX
#endif /* UART_debug_SCLK_PIN_INDEX */
#ifndef UART_debug_SS0_PIN_INDEX
#define UART_debug_SS0_PIN_INDEX              UART_debug_SS0_PIN_INDEX
...
#define UART_debug_SCLK_PIN_MASK             UART_debug_SCLK_PIN_MASK
#endif /* UART_debug_SCLK_PIN_MASK */
#ifndef UART_debug_SS0_PIN_MASK
#define UART_debug_SS0_PIN_MASK              UART_debug_SS0_PIN_MASK
