...
***************************************/
    ...
    #define UART_2_SCLK_HSIOM_SEL_GPIO  (UART_2_spi_sclk__0__HSIOM_GPIO)
    #define UART_2_SCLK_HSIOM_SEL_I2C   (UART_2_spi_sclk__0__HSIOM_I2C)
    #define UART_2_SCLK_HSIOM_SEL_SPI   (UART_2_spi_sclk__0__HSIOM_SPI)
    #define UART_2_SCLK_HSIOM_SEL_UART  (UART_2_spi_sclk__0__HSIOM_UART)
    ...
    #define UART_2_SS0_HSIOM_SEL_GPIO  (UART_2_spi_ss0__0__HSIOM_GPIO)
    #define UART_2_SS0_HSIOM_SEL_I2C   (UART_2_spi_ss0__0__HSIOM_I2C)
    #define UART_2_SS0_HSIOM_SEL_SPI   (UART_2_spi_ss0__0__HSIOM_SPI)
#if !(UART_2_CY_SCBIP_V0 || UART_2_CY_SCBIP_V1)
    #define UART_2_SS0_HSIOM_SEL_UART  (UART_2_spi_ss0__0__HSIOM_UART)
