// ======================================================================
// TestCRC.v generated from TopDesign.cysch
// 05/11/2017 at 22:51
...
`ifdef WARP
`define CY_BLK_DIR "C:\Program Files (x86)\Cypress\PSoC Creator\4.0\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\CRC_v2_40"
`include "C:\Program Files (x86)\Cypress\PSoC Creator\4.0\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\CRC_v2_40\CRC_v2_40.v"
`else
`define CY_BLK_DIR "C:\Program Files (x86)\Cypress\PSoC Creator\4.0\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\CRC_v2_40"
`include "C:\Program Files (x86)\Cypress\PSoC Creator\4.0\PSoC Creator\psoc\content\cycomponentlibrary\CyComponentLibrary.cylib\CRC_v2_40\CRC_v2_40.v"
`endif
...
module top ;
    ...
    CRC_v2_40 CRC_1 (
        ...
        .reset(Net_113),
        .enable(Net_114));
    defparam CRC_1.Resolution = 16;
    defparam CRC_1.TimeMultiplexing = 0;

    SCB_P4_v3_20_0 UART_2 (
        .cts_in(1'b0),
        .tx_out(Net_134),
        .rts_out(Net_135),
        .interrupt(Net_136),
    ...
    UART_v2_50_1 UART_1 (
        ...
        .reset(Net_102),
        .rx(Net_103),
        .tx_interrupt(Net_104),
        .rx_interrupt(Net_152),
        .tx_data(Net_106),
        .tx_clk(Net_107),
        .rx_data(Net_111),
        .rx_clk(Net_112));
